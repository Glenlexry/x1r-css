...
<div class="top-form top-form-minicart ya-minicart-style1 pull-right">
	<div class="top-minicart-icon pull-right">
		<i class="fa fa-shopping-cart"></i><a class="cart-contents" href="<?php echo $woocommerce->cart->get_cart_url(); ?>" title="<?php _e('View your shopping cart', 'yatheme'); ?>"><?php echo '<span class="minicart-number">'.$woocommerce->cart->cart_contents_count.'</span>';  _e('item(s)', 'yatheme');?> :  <?php echo $woocommerce->cart->get_cart_total(); ?></a>
	</div>
	<div class="wrapp-minicart">
		<div class="minicart-padding">
			<h2><?php echo _e('Recent Add Item(s)', 'yatheme');?></h2>
	...
	<div class="detail-item">
		<div class="product-details"> 
			...
			<div class="qty">
				<span class="qty-label"><?php echo _e('Qty:', 'yatheme');?></span>
...
?>
			...
			<div class="cart-checkout">
				...
				<div class="cart-links">
					<div class="cart-link"><a href="<?php echo get_permalink(get_option('woocommerce_cart_page_id')); ?>" title="Cart"><?php _e('View Cart', 'yatheme'); ?></a></div>
